# Compute interactions between players

output_file <- "benchmark/number_interactions_by_days.csv"

get_interactions_file <- function(){
	output_file
}
...
# remove cities, as collaboration in cities are ignored
